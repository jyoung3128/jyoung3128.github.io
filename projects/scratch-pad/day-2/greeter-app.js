...
function greeter(hour) {
    ...
    if (hour <= 11){//here we want to say if the hour is less than 11 or greater than zero then we know it's within morningtime so we can log 'Good Morning!'
        console.log("Good Morning!"); //prolly could have just done less than 11 which I ended up doing lol
    } else if (hour <= 16){
